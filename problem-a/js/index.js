...
console.log(((motto.length/String("The iSchool is my school").length*100).toFixed(2)).concat("%"));
...
if (numbers.length % 2 == 0) {
	console.log((numbers.sort()[numbers.length / 2] + numbers.sort()[numbers.length / 2 - 1]) / 2);
}
else {
...
//Those arrays inherited the hyptotenuse attribute.
